...
public class UserProfileService extends ServiceManager<UserProfile, String> {
    ...
    public UserProfile createUserWithRabbitMq(RegisterElasticModel registerElasticModel){
        return save(IElasticMapper.INSTANCE.registerModelToUser(registerElasticModel));
    }

    /**
     * Elasticsearchde metinsel değerler üzerinde herhangi bir sıralama işlemi yapılmamaktadır.
     * Bu işlemin gerçekleşebilmesi için elasticsearch arayüzüne kibana vb. araçlar ile ulaşarak
     * bazı index ayarlarının yapılması gerekmektedir. Burada sıralama işlemleri sayısal seğerler
     * üzerinde yapılabilmektedir.
     */
